"""taxi_test_18250 URL Configuration
...
admin.site.site_header = "Taxi test"
admin.site.site_title = "Taxi test Admin Portal"
admin.site.index_title = "Taxi test Admin"
...
schema_view = get_schema_view(
    openapi.Info(
        title="Taxi test API",
        default_version="v1",
        description="API documentation for Taxi test App",
    ),
    public=True,
